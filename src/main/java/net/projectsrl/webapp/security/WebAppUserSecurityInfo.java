 ...
 * Questa
 */
public class WebAppUserSecurityInfo<U> extends UserSecurityInfo implements Serializable {

    private static final long serialVersionUID = 3799911539616265110L;
    ...
    private Map<String, Serializable> _sessionMap                   = new HashMap<String, Serializable>();
