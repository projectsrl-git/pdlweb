 ...
 * 
 */
public abstract class FunctionResetPasswordFromFind_base extends FunctionProjectWebApp_base {
    ...
    public static final String  RESET_DA_RICERCA_UTENTI                    = "RESET_DA_RICERCA_UTENTI";
    ...
    public FunctionResetPasswordFromFind_base() {

        super();
    }

    public FunctionResetPasswordFromFind_base(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    public void elabora(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
    	...
    	String operationType="RESETPASSWORD";
        String title = "";
        String message = "";
        String lang = "";
        ...
        try {
            ...
            if (isUniqueEmail(email)) {
                ...
                templateData.put(TAG_ERROR_MESSAGE,Config.GetInstance().getProperty(MESSAGES_TWICE_SAME_EMAIL_ERROR));
            }
        ...
        _applicationSrv.displayPage("ricercautenti", templateData, setPageDatasetParam("ricercautenti", req, templateData),
				res);
