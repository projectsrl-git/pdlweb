...
public class FunctionStampaSchedaProdotto extends FunctionProjectWebApp_base {

    public FunctionStampaSchedaProdotto(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    public void elabora(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
        ...
        String urlToParse = "astro?FUNCTIONID=StampaTest";
        String fileName = "schedaprodotto.pdf";
    ...
    protected Map<String, Object> createMapFromRequest(SsbServletRequest req, UserSecurityInfo userInfo)
        ...
        try {
            ...
            Map<String, Serializable> sessionMap = webAppUserInfo.getSessionMap();
