 ...
 * 
 */
public class FunctionStampaParametriInpsPDF extends FunctionRicercaParametri {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_parametriinps_pdf";
	public static final String XML_NAME_PDF = "elencoparametriinpsPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoparametriinpsPDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaParametriInpsPDF() {
		super();
	}

	public FunctionStampaParametriInpsPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
