 ...
 * 
 */
public class FunctionStampaParametriGiustificativiPDF extends FunctionRicercaParametri {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_parametrigst_pdf";
	public static final String XML_NAME_PDF = "elencoparametrigstPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoparametrigstPDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaParametriGiustificativiPDF() {
		super();
	}

	public FunctionStampaParametriGiustificativiPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
