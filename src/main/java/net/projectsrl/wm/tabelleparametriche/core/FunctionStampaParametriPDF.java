 ...
 * 
 */
public class FunctionStampaParametriPDF extends FunctionRicercaParametri {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_parametri_pdf";
	public static final String XML_NAME_PDF = "elencoparametriPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoparametriPDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaParametriPDF() {
		super();
	}

	public FunctionStampaParametriPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
