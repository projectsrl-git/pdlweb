...
/**
 * Function FunctionStampaTrasfertePDF
 * 
 */
public class FunctionStampaTrasfertePDF extends FunctionRicercaTrasferte {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_trasferte_pdf";
	public static final String XML_NAME_PDF = "elencotrasfertePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencotrasfertePDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaTrasfertePDF() {
		super();
	}

	public FunctionStampaTrasfertePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_trasferte";		
		...
		try {
			...
			fileName="Elenco_trasferte";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_trasferte", "FunctionStampaTrasfertePDF", res);
