 ...
 * 
 */
public class FunctionStampaFeriePermessiPDF extends FunctionRicercaFeriePermessi {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_feriepermessi_pdf";
	public static final String XML_NAME_PDF = "elencoferiepermessiPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoferiepermessiPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaFeriePermessiPDF() {
		super();
	}

	public FunctionStampaFeriePermessiPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_feriepermessi";		
		...
		try {
			...
			fileName="Elenco_feriepermessi";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_feriepermessi", "FunctionStampaFeriePermessiPDF", res);
