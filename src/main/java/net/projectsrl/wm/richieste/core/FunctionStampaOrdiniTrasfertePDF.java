...
/**
 * Function FunctionStampaOrdiniTrasfertePDF
 * 
 */
public class FunctionStampaOrdiniTrasfertePDF extends FunctionRicercaModuliTrasferte {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_ordinitrasferte_pdf";
	public static final String XML_NAME_PDF = "elencoordinitrasfertePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoordinitrasfertePDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaOrdiniTrasfertePDF() {
		super();
	}

	public FunctionStampaOrdiniTrasfertePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_ordinitrasferte";		
		...
		try {
			...
			fileName="Elenco_ordinitrasferte";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_ordinitrasferte", "FunctionStampaOrdiniTrasfertePDF", res);
