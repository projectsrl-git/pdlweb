...
/**
 * Function FunctionStampaMalattieInfortuniPDF
 * 
 */
public class FunctionStampaMalattieInfortuniPDF extends FunctionRicercaMalattieInfortuni {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_malattieinfortuni_pdf";
	public static final String XML_NAME_PDF = "elencomalattieinfortuniPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencomalattieinfortuniPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaMalattieInfortuniPDF() {
		super();
	}

	public FunctionStampaMalattieInfortuniPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_malattieinfortuni";		
		...
		try {
			...
			fileName="Elenco_malattieinfortuni";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_malattieinfortuni", "FunctionStampaMalattieInfortuniPDF", res);
