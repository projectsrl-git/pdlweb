...
/**
 * Function FunctionStampaUtentiPDF
 * 
 */
public class FunctionStampaComunicazioneInfortuniPDF extends FunctionRicercaTrasferte {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_rendicontazioni_pdf";
	public static final String XML_NAME_PDF = "elencorendicontazioniPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencorendicontazioniPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaComunicazioneInfortuniPDF() {
		super();
	}

	public FunctionStampaComunicazioneInfortuniPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_rendicontazioni";		
		...
		try {
			...
			fileName="Elenco_rendicontazioni";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_rendicontazioni", "FunctionStampaRendicontazioniPDF", res);
