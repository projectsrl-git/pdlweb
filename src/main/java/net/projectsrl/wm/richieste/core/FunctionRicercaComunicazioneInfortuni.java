 ...
 * 
 */
public class FunctionRicercaComunicazioneInfortuni extends FunctionRicerca {

    private static final String PAGE_IMPOSTA = "ricerca_comunicazioneinfortuni";
    private static final String PAGE_RISULTATI = "browse_comunicazioneinfortuni";    
    

    public FunctionRicercaComunicazioneInfortuni() {
        super();
        setPageImposta(PAGE_IMPOSTA);
        setPageRisultati(PAGE_RISULTATI);
    }

    public FunctionRicercaComunicazioneInfortuni(ApplicationServices_itf applServices, String functionID, String functionName) {
