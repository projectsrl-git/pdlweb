...
/**
 * Function FunctionStampaStraordinariPDF
 * 
 */
public class FunctionStampaStraordinariPDF extends FunctionRicercaStraordinari {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_straordinari_pdf";
	public static final String XML_NAME_PDF = "elencostraordinariPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencostraordinariPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaStraordinariPDF() {
		super();
	}

	public FunctionStampaStraordinariPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_straordinari";		
		...
		try {
			...
			fileName="Elenco_straordinari";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_straordinari", "FunctionStampaStraordinariPDF", res);
