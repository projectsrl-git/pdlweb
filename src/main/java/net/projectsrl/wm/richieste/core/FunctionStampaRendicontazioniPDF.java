...
/**
 * Function FunctionStampaRendicontazioniPDF
 * 
 */
public class FunctionStampaRendicontazioniPDF extends FunctionRicercaRendicontazioni {
	...
	public FunctionStampaRendicontazioniPDF() {
		super();
	}

	public FunctionStampaRendicontazioniPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
