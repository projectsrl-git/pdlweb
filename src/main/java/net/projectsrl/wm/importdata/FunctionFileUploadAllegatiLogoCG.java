...
public class FunctionFileUploadAllegatiLogoCG extends FunctionFileUploadDocumentiParametri_base {

    public FunctionFileUploadAllegatiLogoCG() {

        super();
    }

    public FunctionFileUploadAllegatiLogoCG(ApplicationServices_itf applServices, String functionID, String functionName) {
