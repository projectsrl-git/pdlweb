...
public class FunctionFileUploadAllegatiCV extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiCV() {

        super();
    }

    public FunctionFileUploadAllegatiCV(ApplicationServices_itf applServices, String functionID, String functionName) {
