...
public class FunctionFileUploadAllegatiAltro extends FunctionFileUploadDocumentiParametri_base {

    public FunctionFileUploadAllegatiAltro() {

        super();
    }

    public FunctionFileUploadAllegatiAltro(ApplicationServices_itf applServices, String functionID, String functionName) {
