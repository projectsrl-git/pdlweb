...
public class FunctionFileUploadAllegatiArchivioCVContrattoLavoro extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiArchivioCVContrattoLavoro() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioCVContrattoLavoro(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idTaggancio != null) {
            String inserisciNome = "INSERT INTO CURRICULUM_ATCH_CLAV (DAGGANCIO,DAGGANCIO_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idTaggancio
                    + "','" + Utils.getUnique() + "','','"+fileName + "','','C','"+Utils.getStringDataOggiRibaltata()+"','"+Utils.getOrario()+"')";
