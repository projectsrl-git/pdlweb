...
public class FunctionFileUploadAllegatiCVFotoCG extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiCVFotoCG() {

        super();
    }

    public FunctionFileUploadAllegatiCVFotoCG(ApplicationServices_itf applServices, String functionID, String functionName) {
