...
public class FunctionFileUploadAllegatiRendicontazioni_OLD extends FunctionFileUploadDocumenti_base {

    public FunctionFileUploadAllegatiRendicontazioni_OLD() {

        super();
    }

    public FunctionFileUploadAllegatiRendicontazioni_OLD(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPaginaChiusuraPopup() {
        ...
        return "file_upload_allegati_rendicontazioni_chiudi";
    }
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idMalattiaInfortunio != null) {
            String inserisciNome = "INSERT INTO RENDICONTAZIONI_ATCH (ID_RENDICONTAZIONE,ID_RENDICONTAZIONE_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idMalattiaInfortunio
