 ...
 * 
 */
public abstract class FunctionFileUploadDocumentiParametri_base extends FunctionWebApp_base {
    ...
    public FunctionFileUploadDocumentiParametri_base() {

        super();
    }

    public FunctionFileUploadDocumentiParametri_base(ApplicationServices_itf applServices, String functionID, String functionName) {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (!fi.isFormField()) {
                    ...
                    String directory = _applicationSrv.getRoot() + "areadocumenti"+"/"+dirDocumentiAzienda;
