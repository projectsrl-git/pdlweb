...
public class FunctionFileUploadAllegatiPolicy extends FunctionFileUploadDocumentiParametri_base {

    public FunctionFileUploadAllegatiPolicy() {

        super();
    }

    public FunctionFileUploadAllegatiPolicy(ApplicationServices_itf applServices, String functionID, String functionName) {
