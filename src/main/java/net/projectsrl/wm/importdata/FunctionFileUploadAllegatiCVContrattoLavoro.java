...
public class FunctionFileUploadAllegatiCVContrattoLavoro extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiCVContrattoLavoro() {

        super();
    }

    public FunctionFileUploadAllegatiCVContrattoLavoro(ApplicationServices_itf applServices, String functionID, String functionName) {
