...
public class FunctionFileUploadAllegatiCVInformativaMadri extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiCVInformativaMadri() {

        super();
    }

    public FunctionFileUploadAllegatiCVInformativaMadri(ApplicationServices_itf applServices, String functionID, String functionName) {
