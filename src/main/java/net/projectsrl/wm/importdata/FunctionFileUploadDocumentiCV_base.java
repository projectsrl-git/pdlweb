 ...
 * 
 */
public abstract class FunctionFileUploadDocumentiCV_base extends FunctionWebApp_base {
    ...
    public FunctionFileUploadDocumentiCV_base() {

        super();
    }

    public FunctionFileUploadDocumentiCV_base(ApplicationServices_itf applServices, String functionID, String functionName) {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (!fi.isFormField()) {
                    ...
                    String dirCV =_applicationSrv.getRoot()+Config.GetInstance().getProperty("cartella.cv")+(String) req.getSession(false).getAttribute("ID_CURRICULUM_SESSIONE");
                    new File(dirCV).mkdir();
                    String dirDocumentiCV=(String) req.getSession(false).getAttribute("ID_CURRICULUM_SESSIONE");
                    
                    String directory = _applicationSrv.getRoot() + "cv"+"/"+dirDocumentiCV;
