...
public class FunctionFileUploadAllegatiArchivioCV extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiArchivioCV() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioCV(ApplicationServices_itf applServices, String functionID, String functionName) {
