...
public class FunctionFileUploadAllegati extends FunctionFileUploadDocumenti_base {

    public FunctionFileUploadAllegati() {

        super();
    }

    public FunctionFileUploadAllegati(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPaginaChiusuraPopup() {
        ...
        return "file_upload_allegati_chiudi";
    }
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idFeriePermesso != null) {
            String inserisciNome = "INSERT INTO FERIE_PERMESSI_ATCH (ID_FERIEPERMESSO,ID_FERIEPERMESSO_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idFeriePermesso
