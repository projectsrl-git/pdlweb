...
public class FunctionFileUploadAllegatiCVCG extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiCVCG() {

        super();
    }

    public FunctionFileUploadAllegatiCVCG(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected String getPaginaChiusuraPopup() {
        ...
        return "file_upload_allegati_cv_chiudi_cg";
    }
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idTaggancio != null) {
            String inserisciNome = "INSERT INTO CURRICULUM_ATCH (DAGGANCIO,DAGGANCIO_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idTaggancio
    ...
    protected HashMap<String, Object> setCommonTags(SsbServletRequest req, UserSecurityInfo userInfo) throws AppCrash {
        ...
        templateData.put("CATPROT", (String) req.getSession(false).getAttribute(Costanti_itf.ID_CATPROT_SESSIONE));
