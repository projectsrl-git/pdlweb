...
public class FunctionFileUploadAllegatiArchivioModulistica extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiArchivioModulistica() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioModulistica(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idTaggancio != null) {
            String inserisciNome = "INSERT INTO MODULISTICA_ATCH (DAGGANCIO,DAGGANCIO_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idTaggancio
                    + "','" + Utils.getUnique() + "','','"+fileName + "','','','"+Utils.getStringDataOggiRibaltata()+"','"+Utils.getOrario()+"')";
