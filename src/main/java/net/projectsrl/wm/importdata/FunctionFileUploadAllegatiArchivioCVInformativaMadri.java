...
public class FunctionFileUploadAllegatiArchivioCVInformativaMadri extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiArchivioCVInformativaMadri() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioCVInformativaMadri(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        String idTaggancio = (String) req.getSession(false).getAttribute(Costanti_itf.ID_DIPENDENTE_ARCHIVIO);
        if (idTaggancio != null) {
            String inserisciNome = "INSERT INTO CURRICULUM_ATCH_LMAD (DAGGANCIO,DAGGANCIO_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idTaggancio
                    + "','" + Utils.getUnique() + "','','"+fileName + "','','M','"+Utils.getStringDataOggiRibaltata()+"','"+Utils.getOrario()+"')";
