...
public class FunctionFileUploadAllegatiArchivioCVPrivacy extends FunctionFileUploadDocumentiCV_base {

    public FunctionFileUploadAllegatiArchivioCVPrivacy() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioCVPrivacy(ApplicationServices_itf applServices, String functionID, String functionName) {
