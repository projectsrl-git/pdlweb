...
public class FunctionFileUploadAllegatiArchivioTrasferte extends FunctionFileUploadDocumenti_base {

    public FunctionFileUploadAllegatiArchivioTrasferte() {

        super();
    }

    public FunctionFileUploadAllegatiArchivioTrasferte(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (azienda != null) {
            String inserisciNome = "INSERT INTO TRASFERTE_ATCH (ID_TRASFERTA,ID_TRASFERTA_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES "
