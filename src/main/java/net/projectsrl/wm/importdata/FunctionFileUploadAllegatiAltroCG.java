...
public class FunctionFileUploadAllegatiAltroCG extends FunctionFileUploadDocumentiParametri_base {

    public FunctionFileUploadAllegatiAltroCG() {

        super();
    }

    public FunctionFileUploadAllegatiAltroCG(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    protected void loadData(String sessionUser, String absolutePathFileName, SsbServletRequest req) throws AppCrash {
        ...
        if (idTaggancio != null) {
            String inserisciNome = "INSERT INTO DOCAZIENDA_ATCH (ID_DOCAZIENDA,ID_DOCAZIENDA_ATCH,PERCORSO,FILENAME,AZIENDA,MATRICOLA,DATA_CARICAMENTO,ORA_CARICAMENTO) VALUES ('" + idTaggancio
                    + "','" + Utils.getUnique() + "','','"+fileName + "','"+azienda+"','A','"+Utils.getStringDataOggiRibaltata()+"','"+Utils.getOrario()+"')";
