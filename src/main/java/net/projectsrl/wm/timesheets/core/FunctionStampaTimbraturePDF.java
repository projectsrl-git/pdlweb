 ...
 * 
 */
public class FunctionStampaTimbraturePDF extends FunctionRicercaTimbrature {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_timbrature_pdf";
	public static final String XML_NAME_PDF = "elencotimbraturePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencotimbraturePDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaTimbraturePDF() {
		super();
	}

	public FunctionStampaTimbraturePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_timbrature";		
		...
		try {
			...
			fileName="Elenco_timbrature";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_timbrature", "FunctionStampaTimbraturePDF", res);
