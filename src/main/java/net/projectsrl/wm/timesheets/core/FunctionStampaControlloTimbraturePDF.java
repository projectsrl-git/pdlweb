...
/**
 * Function FunctionStampaTimbraturePDF
 * 
 */
public class FunctionStampaControlloTimbraturePDF extends FunctionControlloTimbrature {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_controllotimbrature_pdf";
	public static final String XML_NAME_PDF = "elencocontrollotimbraturePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencocontrollotimbraturePDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaControlloTimbraturePDF() {
		super();
	}

	public FunctionStampaControlloTimbraturePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_controllotimbrature";		
		...
		try {
			...
			fileName="Elenco_controllotimbrature";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_controllotimbrature", "FunctionStampaControlloTimbraturePDF", res);
