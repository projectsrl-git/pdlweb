 ...
 * 
 */
public class FunctionInserimentoProfiloOrario extends FunctionInserimento {

	private static final String PAGE = "inserimento_profiloorario";
	

	public FunctionInserimentoProfiloOrario() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
	...
	public FunctionInserimentoProfiloOrario(ApplicationServices_itf applServices, String functionID, String functionName) {
