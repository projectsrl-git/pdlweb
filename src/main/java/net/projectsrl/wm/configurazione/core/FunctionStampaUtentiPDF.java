 ...
 * 
 */
public class FunctionStampaUtentiPDF extends FunctionRicercaUtenti {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_utenti_pdf";
	public static final String XML_NAME_PDF = "elencoutentiPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoutentiPDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaUtentiPDF() {
		super();
	}

	public FunctionStampaUtentiPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		try {
			...
			fileName="Elenco_utenti";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_utenti", "FunctionStampaUtentiPDF", res);
