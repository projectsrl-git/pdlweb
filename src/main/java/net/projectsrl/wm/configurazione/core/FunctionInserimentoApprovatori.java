...
/**
 * FunctionInserimentoApprovatori
 * 
 */
public class FunctionInserimentoApprovatori extends FunctionInserimento {

    private static final String PAGE   = "inserimento_approvatori";
    
    public FunctionInserimentoApprovatori() {

        super();
        setPageMostra(PAGE);
        setPageElabora(PAGE);
        setDatasetTestata("DataSetApprovatori");
    }

    public FunctionInserimentoApprovatori(ApplicationServices_itf applServices, String functionID, String functionName) {
