...
/**
 * Function FunctionStampaProfiloOrarioPDF
 * 
 */
public class FunctionStampaProfiloOrarioPDF extends FunctionRicercaProfiloOrario {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_profilo_orario_pdf";
	public static final String XML_NAME_PDF = "elencoprofiloorarioPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoprofiloorarioPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaProfiloOrarioPDF() {
		super();
	}

	public FunctionStampaProfiloOrarioPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_profilo_orario";		
		...
		try {
			...
			fileName="Elenco_profilo_orario";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_profilo_orario", "FunctionStampaProfiloOrarioPDF", res);
