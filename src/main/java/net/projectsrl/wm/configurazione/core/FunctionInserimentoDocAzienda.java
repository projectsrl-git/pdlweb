 ...
 * 
 */
public class FunctionInserimentoDocAzienda extends FunctionInserimento {

	private static final String PAGE = "inserimento_docazienda";
	

	public FunctionInserimentoDocAzienda() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
	...
	public FunctionInserimentoDocAzienda(ApplicationServices_itf applServices, String functionID, String functionName) {
