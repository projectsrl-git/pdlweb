...
/**
 * Function FunctionStampaBadgePDF
 * 
 */
public class FunctionStampaBadgePDF extends FunctionRicercaBadge {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_badge_pdf";
	public static final String XML_NAME_PDF = "elencobadgePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencobadgePDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaBadgePDF() {
		super();
	}

	public FunctionStampaBadgePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		try {
			...
			fileName="Elenco_badge";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_badge", "FunctionStampaBadgePDF", res);
