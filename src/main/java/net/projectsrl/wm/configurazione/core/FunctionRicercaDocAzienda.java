...
/**
 * FunctionRicercaDocumenti
 * 
 */
public class FunctionRicercaDocAzienda extends FunctionRicerca {

    private static final String PAGE_IMPOSTA = "ricerca_docazienda";
    private static final String PAGE_RISULTATI = "browse_docazienda";    
    

    public FunctionRicercaDocAzienda() {
        super();
        setPageImposta(PAGE_IMPOSTA);
        setPageRisultati(PAGE_RISULTATI);
    }

    public FunctionRicercaDocAzienda(ApplicationServices_itf applServices, String functionID, String functionName) {
