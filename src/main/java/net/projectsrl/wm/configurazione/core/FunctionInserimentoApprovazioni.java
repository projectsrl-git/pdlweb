 ...
 * 
 */
public class FunctionInserimentoApprovazioni extends FunctionInserimentoMenu {

	private static final String PAGE = "inserimento_approvazioni";

	public FunctionInserimentoApprovazioni() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
		setDatasetTestata("DataSetApprovazioni");
	}

	public FunctionInserimentoApprovazioni(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	private void gestioneApprovazioni( SsbServletRequest req) throws AppCrash {
			...
			String dsName="DataSetApprovazioni";
			...
			try {
				...
				while (dataSet.hasMoreElements()) {
					...
					if (dbRow != null) {
						...
						String dbApprovatore1Livello = (String) dbRow.getField(ApprovazioniDAO.LIVELLO_1);
						if (!strApprovatore1Livello.equals(dbApprovatore1Livello)) {
							String sqlUpdate ="UPDATE APPROVAZIONI SET LIVELLO_1='"+strApprovatore1Livello+"' WHERE ID_GRUPPO ='"+dbCODICE+"' AND AZIENDA ='"+azienda+"'";
							net.projectsrl.wm.utils.WMUtils.executeQuery(sqlUpdate);
						}
						
						String strApprovatore2Livello = req.getField(dbCODICE + "_FLAG_2");
						String dbApprovatore2Livello = (String) dbRow.getField(ApprovazioniDAO.LIVELLO_2);
						if (!strApprovatore2Livello.equals(dbApprovatore2Livello)) {
							String sqlUpdate ="UPDATE APPROVAZIONI SET LIVELLO_2='"+strApprovatore2Livello+"' WHERE ID_GRUPPO ='"+dbCODICE+"' AND AZIENDA ='"+azienda+"'";
							net.projectsrl.wm.utils.WMUtils.executeQuery(sqlUpdate);
						}
						
						String strApprovatore3Livello = req.getField(dbCODICE + "_FLAG_3");
						String dbApprovatore3Livello = (String) dbRow.getField(ApprovazioniDAO.LIVELLO_3);
						if (!strApprovatore3Livello.equals(dbApprovatore3Livello)) {
							String sqlUpdate ="UPDATE APPROVAZIONI SET LIVELLO_3='"+strApprovatore3Livello+"' WHERE ID_GRUPPO ='"+dbCODICE+"' AND AZIENDA ='"+azienda+"'";
							net.projectsrl.wm.utils.WMUtils.executeQuery(sqlUpdate);
						}
						
						String strApprovatore4Livello = req.getField(dbCODICE + "_FLAG_4");
						String dbApprovatore4Livello = (String) dbRow.getField(ApprovazioniDAO.LIVELLO_4);
						if (!strApprovatore4Livello.equals(dbApprovatore4Livello)) {
							String sqlUpdate ="UPDATE APPROVAZIONI SET LIVELLO_4='"+strApprovatore4Livello+"' WHERE ID_GRUPPO ='"+dbCODICE+"' AND AZIENDA ='"+azienda+"'";
							net.projectsrl.wm.utils.WMUtils.executeQuery(sqlUpdate);
						}
						
						String strApprovatore5Livello = req.getField(dbCODICE + "_FLAG_5");
						String dbApprovatore5Livello = (String) dbRow.getField(ApprovazioniDAO.LIVELLO_5);
						if (!strApprovatore5Livello.equals(dbApprovatore5Livello)) {
							String sqlUpdate ="UPDATE APPROVAZIONI SET LIVELLO_5='"+strApprovatore5Livello+"' WHERE ID_GRUPPO ='"+dbCODICE+"' AND AZIENDA ='"+azienda+"'";
							net.projectsrl.wm.utils.WMUtils.executeQuery(sqlUpdate);
						}
				...
				ac.logContext("FunctionInserimentoApprovazioni", "Errore nella ricerca campi del dataset " + dsName);
				throw ac;
			} finally {
				...
				if (dataSet != null) {
					try {
						...
						ac.logContext("FunctionInserimentoApprovazioni", "Errore nella close del dataset " + dsName);
					}
				}
			}
		}
