 ...
 * 
 */
public class FunctionInserimentoSediAziendaliCG extends FunctionInserimento {

	private static final String PAGE = "inserimento_sediaziendali_cg";
	

	public FunctionInserimentoSediAziendaliCG() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
	...
	public FunctionInserimentoSediAziendaliCG(ApplicationServices_itf applServices, String functionID, String functionName) {
