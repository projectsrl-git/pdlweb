 ...
 * 
 */
public class FunctionInserimentoAziendeCG extends FunctionInserimento {

	private static final String PAGE = "inserimento_aziende_cg";
	

	public FunctionInserimentoAziendeCG() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
	...
	public FunctionInserimentoAziendeCG(ApplicationServices_itf applServices, String functionID, String functionName) {
