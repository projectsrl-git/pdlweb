...
/**
 * FunctionEscludiAttivita
 * 
 */
public class FunctionEscludiAttivita extends FunctionInserimentoSenzaControlloPreEsistenza {

	private static final String PAGE = "escludi_attivita";
	

	public FunctionEscludiAttivita() {
		super();
		setPageMostra(PAGE);
		setPageElabora(PAGE);
		setDatasetTestata("DataSetDipendenteXNoAttivita");
	}

	public FunctionEscludiAttivita(ApplicationServices_itf applServices, String functionID, String functionName) {
