...
/**
 * Function FunctionStampaCurriculumPDF
 * 
 */
public class FunctionStampaCurriculumPDF extends FunctionRicercaCurriculum {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_curriculum_pdf";
	public static final String XML_NAME_PDF = "elencocurriculumPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencocurriculumPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaCurriculumPDF() {
		super();
	}

	public FunctionStampaCurriculumPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_curriculum";		
		...
		try {
			...
			fileName="Elenco_curriculum";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_curriculum", "FunctionStampaCurriculumPDF", res);
