...
/**
 * Function FunctionStampaAziendePDF
 * 
 */
public class FunctionStampaAziendeVisitatoriPDF extends FunctionRicercaAziendeVisitatori {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_aziende_visitatori_pdf";
	public static final String XML_NAME_PDF = "elencoaziendevisitatoriPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoaziendevisitatoriPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaAziendeVisitatoriPDF() {
		super();
	}

	public FunctionStampaAziendeVisitatoriPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_aziende_visitatori";		
		...
		try {
			...
			fileName="Elenco_aziende_visitatori";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_aziende", "FunctionStampaAziendeVisitatoriPDF", res);
