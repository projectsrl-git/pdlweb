...
/**
 * Function FunctionRicercaVisitatori
 * 
 */
public class FunctionStampaVisitatoriPDF extends FunctionRicercaVisitatori {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_visitatori_pdf";
	public static final String XML_NAME_PDF = "elencovisitatoriPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencovisitatoriPDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaVisitatoriPDF() {
		super();
	}

	public FunctionStampaVisitatoriPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_visitatori";		
		...
		try {
			...
			fileName="Elenco_visitatori";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_visitatori", "FunctionStampaVisitatoriPDF", res);
