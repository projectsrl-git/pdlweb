 ...
 */
public class ApprovazioniRendicontazioniDAO extends PjDAO_base {

    private static final String NOME_TABELLA        = "APPROVAZIONI_RENDICONTAZIONI";
    ...
    public ApprovazioniRendicontazioniDAO() throws AppCrash {

        super(NOME_TABELLA);
        setUniqueIdentifier(ID_GRUPPO);
    }

    public ApprovazioniRendicontazioniDAO(DBTransaction transact) throws AppCrash {

        super(transact, NOME_TABELLA);
        setUniqueIdentifier(ID_GRUPPO);
    }

    public ApprovazioniRendicontazioniDAO(DBTransaction transact, String tableName) throws AppCrash {
