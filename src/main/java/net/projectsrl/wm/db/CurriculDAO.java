...
public class CurriculDAO extends PjDAO_base {
	...
	public CurriculDAO() throws AppCrash {
		super(NOME_TABELLA);
		setUniqueIdentifier(TAGGANCIO);
	}


	public CurriculDAO(DBTransaction transact) throws AppCrash {
		super(transact, NOME_TABELLA);
		setUniqueIdentifier(TAGGANCIO);
	}

	public CurriculDAO(DBTransaction transact, String tableName) throws AppCrash {
