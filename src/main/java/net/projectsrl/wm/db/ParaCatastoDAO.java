...
public class ParaCatastoDAO extends PjDAO_base {

    private static final String NOME_TABELLA = "PARA_CATASTO";
    ...
    public ParaCatastoDAO() throws AppCrash {

        super(NOME_TABELLA);
		setUniqueIdentifier(CODICE);
    }

    public ParaCatastoDAO(DBTransaction transact) throws AppCrash {

        super(transact, Config.GetInstance().getProperty("DBEntity.NomeDB") + NOME_TABELLA);
		setUniqueIdentifier(CODICE);
    }

    public ParaCatastoDAO(DBTransaction transact, String tableName) throws AppCrash {
