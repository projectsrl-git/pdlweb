...
/**
 * Function FunctionStampaSediAziendaliPDF
 * 
 */
public class FunctionStampaSediAziendaliPDF extends FunctionRicercaSediAziendali {


	public static final String PAGE_STAMPA_PDF = "stampa_elenco_sedi_aziendali_pdf";
	public static final String XML_NAME_PDF = "elencosediaziendaliPDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencosediaziendaliPDF.xsl";
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";	
	
	public FunctionStampaSediAziendaliPDF() {
		super();
	}

	public FunctionStampaSediAziendaliPDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_sedi_aziendali";		
		...
		try {
			...
			fileName="Elenco_sedi_aziendali";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_sedi_aziendali", "FunctionStampaSediAziendaliPDF", res);
