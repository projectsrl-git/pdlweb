 ...
 * 
 */
public class FunctionStampaAziendePDF extends FunctionRicercaAziende {

	public static final String PAGE_STAMPA_PDF = "stampa_elenco_aziende_pdf";
	public static final String XML_NAME_PDF = "elencoaziendePDF.xml";
	public static final String XSL_NAME_PDF_COMPLETA = "elencoaziendePDF.xsl";	
	private static final String DATASET_LOGO = "DataSetAllegatiLogo";
	
	public FunctionStampaAziendePDF() {
		super();
	}

	public FunctionStampaAziendePDF(ApplicationServices_itf applServices, String functionID, String functionName) {
	...
	public void mostra(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
		...
		String fileName="Elenco_aziende";		
		...
		try {
			...
			fileName="Elenco_aziende";
			fileName="./doc/"+fileName+".pdf";
			templateData.put("filename",fileName);
			
            readPDFFile(fileName, "Elenco_aziende", "FunctionStampaAziendePDF", res);
