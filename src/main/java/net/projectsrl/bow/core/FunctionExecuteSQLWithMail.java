 ...
 */
public class FunctionExecuteSQLWithMail extends FunctionProjectWebApp_base {

    public FunctionExecuteSQLWithMail(ApplicationServices_itf applServices, String functionID,
            String functionName) {
    ...
    public void elabora(SsbServletRequest req, SsbServletResponse res, UserSecurityInfo userInfo) throws AppCrash {
        ...
        try {
            ...
            String idPdl=req.getField("ID_PDL_AVANZAMENTO");
            String descrImpianto=req.getField("DESCR_IMPIANTO_AVANZAMENTO");
            String descrArea=req.getField("DESCR_AREA_AVANZAMENTO");
           
            inviaMailNotifica(userInfo, idPdl,descrImpianto,descrArea);
    ...
    private void inviaMailNotifica(UserSecurityInfo userInfo, String idPdl, String descrImpianto, String descrArea) throws AppCrash {

    	

        SendMail mail = new SendMail(getSpecificUserInfo(userInfo));

        mail.sendMailInterferenza(idPdl,descrImpianto,descrArea);
