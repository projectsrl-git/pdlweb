...
public class AliMod52DettagliDAO extends AliModDettagliDAO_base {

    private static final String TABLE_PARENT_NAME = "ALIMOD52";

    //private static final String AZIONE_CORRETTIVA   = "COR";

    private static final String TABLE_NAME          = "ALIMOD52_DETTAGLI";
    ...
    public static final String  MESE_RIUNIONE = "MESE_RIUNIONE";
    public static final String  DATA_RIUNIONE = "DATA_RIUNIONE";
...
public static final String  STATO_AZIONE    = "STATO_AZIONE";
    ...
    public AliMod52DettagliDAO() throws AppCrash {

        super(TABLE_NAME);
    }

    public AliMod52DettagliDAO(DBTransaction transact) throws AppCrash {

        super(transact, TABLE_NAME);
    }

    public AliMod52DettagliDAO(DBTransaction transact, String tableName) throws AppCrash {
    ...
    private void closeActionPlan() throws AppCrash {
        ...
        AliMod52DAO dao = new AliMod52DAO();
        dao.setAttribute(AliMod52DAO.ID_MODULO, idModulo);
        dao.setAttribute(AliMod52DAO.STATO, "CLO");
        dao.update();
    }
    ...
    public void update() throws AppCrash {
        ...
        AliMod52DettagliDAO daoOld=new AliMod52DettagliDAO();
