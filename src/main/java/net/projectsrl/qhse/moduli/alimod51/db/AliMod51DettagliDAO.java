...
public class AliMod51DettagliDAO extends AliModDettagliDAO_base {

    private static final String TABLE_NAME           = "ALIMOD51_DETTAGLI";

    public static final String  ARGOMENTO            = "ARGOMENTO";
    public static final String  AZIONE_NOTA_COMMENTO = "AZIONE_NOTA_COMMENTO";
    ...
    public AliMod51DettagliDAO() throws AppCrash {

        super(TABLE_NAME);
    }

    public AliMod51DettagliDAO(DBTransaction transact) throws AppCrash {

        super(transact, TABLE_NAME);
    }

    public AliMod51DettagliDAO(DBTransaction transact, String tableName) throws AppCrash {
    ...
    private void closeActionPlan() throws AppCrash {
        ...
        AliMod51DAO dao = new AliMod51DAO();
        dao.setAttribute(AliMod51DAO.ID_MODULO, idModulo);
        dao.setAttribute(AliMod51DAO.STATO, "CLO");
        dao.update();
    }
    ...
    private boolean isActionPlanClosed() throws AppCrash {
        ...
        Integer idModulo = (Integer) getAttribute(ID_MODULO);
        String dsName = "DSALIMOD51Dettaglio";
    ...
    /*
     * @Override public void insert() throws AppCrash { setAttribute(STATO_AZIONE, "OPE"); super.insert();
     * 
     * AliMod51DAO aliMod51DAO = new AliMod51DAO(); aliMod51DAO.setAttribute(ID_MODULO, getAttribute(ID_MODULO));
     * aliMod51DAO.retrieve();
     * 
     * AliMod51DettagliDAO aliMod51DettagliDAO = new AliMod51DettagliDAO();
     * aliMod51DettagliDAO.setAttribute(ID_DETTAGLIO, getAttribute(ID_DETTAGLIO)); aliMod51DettagliDAO.retrieve();
     * 
     * AliMod20DAO aliMod20DAO = new AliMod20DAO(); aliMod20DAO.setAttribute(AliMod20DAO.TABELLA_PARENT,
     * TABLE_PARENT_NAME); aliMod20DAO.setAttribute(AliMod20DAO.ID_MODULO_PARENT,
     * aliMod51DAO.getAttribute(AliModDAO_base.ID_MODULO)); if (!aliMod20DAO.retrieve()) {
     ...
     * aliMod20DAO.setAttribute(AliMod20DAO.TITOLO, "PdA da Visita Comportamentale di Sicurezza #" +
     * aliMod51DAO.getAttribute(AliModDAO_base.NR_MODULO) + " del " +
     * aliMod51DAO.getAttribute(AliModDAO_base.DT_MODULO)); aliMod20DAO.setAttribute(AliModDAO_base.DT_MODULO,
     * Utils.getStringDataOggiRibaltata()); aliMod20DAO.setAttribute(AliModDAO_base.STATO,
     * StatiRichiesta.WAITNG_FOR_FIRST_APPROVAL.getCode());
     * 
     * aliMod20DAO.insert(); }
     * 
     ...
     * aliMod20DettagliDAO.setAttribute(AliMod20DettagliDAO.RIFERIMENTO_ORIGINE, "Visita Comportamentale di Sicurezza #"
     * + aliMod51DAO.getAttribute(AliMod51DAO.NR_MODULO) + " del " + aliMod51DAO.getAttribute(AliMod51DAO.DT_MODULO));
     ...
     * aliMod20DettagliDAO.setAttribute(AliMod20DettagliDAO.TABELLA_PARENT, TABLE_NAME); aliMod20DettagliDAO.insert(); }
     */
    ...
    public void update() throws AppCrash {
        ...
        AliMod51DettagliDAO daoOld = new AliMod51DettagliDAO();
