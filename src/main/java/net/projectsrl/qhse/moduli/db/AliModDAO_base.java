...
package net.projectsrl.qhse.moduli.db;
...
public abstract class AliModDAO_base extends PjNDAO_base {
    ...
    public static final String  CODICE_BL             = "CODICE_BL";
    public static final String  ID_AZIENDA            = "ID_AZIENDA";

    public static final String  NR_MODULO             = "NR_MODULO";
    public static final String  DT_MODULO             = "DT_MODULO";
    public static final String  STATO                 = "STATO";
    public static final String  ID_UTENTE_CON         = "ID_UTENTE_CON";
    public static final String  ID_UTENTE_APP         = "ID_UTENTE_APP";
    ...
    protected void init() throws AppCrash {
        ...
        addNoStringField(ID_UTENTE_CON, Integer.class);
        addNoStringField(ID_UTENTE_APP, Integer.class);
