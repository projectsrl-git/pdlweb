...
public class AliMod67DettagliDAO extends AliModDettagliDAO_base {

    private static final String TABLE_PARENT_NAME = "ALIMOD67";

    private static final String AZIONE_CORRETTIVA   = "COR";

    private static final String TABLE_NAME          = "ALIMOD67_DETTAGLI";
    ...
    public static final String  AZIONI_RACCOMANDATE = "AZIONI_RACCOMANDATE";

    public AliMod67DettagliDAO() throws AppCrash {

        super(TABLE_NAME);
    }

    public AliMod67DettagliDAO(DBTransaction transact) throws AppCrash {

        super(transact, TABLE_NAME);
    }

    public AliMod67DettagliDAO(DBTransaction transact, String tableName) throws AppCrash {
    ...
    private void closeActionPlan() throws AppCrash {
        ...
        AliMod67DAO dao = new AliMod67DAO();
        dao.setAttribute(AliMod67DAO.ID_MODULO, idModulo);
        dao.setAttribute(AliMod67DAO.STATO, "CLO");
        dao.update();
    }
    ...
    private boolean isActionPlanClosed() throws AppCrash {
        ...
        Integer idModulo = (Integer) getAttribute(ID_MODULO);
        String dsName = "DSALIMOD67Dettaglio";
    ...
    public void insert() throws AppCrash {
        ...
        AliMod67DAO aliMod67DAO = new AliMod67DAO();
        aliMod67DAO.setAttribute(ID_MODULO, getAttribute(ID_MODULO));
        aliMod67DAO.retrieve();

        AliMod67DettagliDAO aliMod50DettagliDAO = new AliMod67DettagliDAO();
        ...
        aliMod20DAO.setAttribute(AliMod20DAO.ID_MODULO_PARENT, aliMod67DAO.getAttribute(AliModDAO_base.ID_MODULO));
        if (!aliMod20DAO.retrieve()) {
            aliMod20DAO.setAttribute(AliModDAO_base.ID_AZIENDA, aliMod67DAO.getAttribute(AliModDAO_base.ID_AZIENDA));
            aliMod20DAO.setAttribute(AliModDAO_base.CODICE_BL, aliMod67DAO.getAttribute(AliModDAO_base.CODICE_BL));
            aliMod20DAO.setAttribute(AliModDAO_base.ID_UTENTE_INS, aliMod67DAO.getAttribute(AliModDAO_base.ID_UTENTE_INS));
            aliMod20DAO.setAttribute(AliModDAO_base.ID_UTENTE_CON, aliMod67DAO.getAttribute(AliModDAO_base.ID_UTENTE_CON));
            aliMod20DAO.setAttribute(AliMod20DAO.TITOLO,
                    "PdA da Visita Comportamentale di Sicurezza #" + aliMod67DAO.getAttribute(AliMod67DAO.NR_MODULO)
                            + " del " + aliMod67DAO.getAttribute(AliMod67DAO.DT_MODULO));
        ...
        aliMod20DettagliDAO.setAttribute(AliMod20DettagliDAO.RIFERIMENTO_ORIGINE,
                "Visita Comportamentale di Sicurezza #" + aliMod67DAO.getAttribute(AliMod67DAO.NR_MODULO) + " del "
                        + aliMod67DAO.getAttribute(AliModDAO_base.DT_MODULO));
        ...
        aliMod20DettagliDAO.setAttribute(AliMod20DettagliDAO.ID_UTENTE_RES,
                aliMod67DAO.getAttribute(AliMod67DAO.ID_UTENTE_CON));
        aliMod20DettagliDAO.setAttribute(AliMod20DettagliDAO.ID_UTENTE_INS,
                aliMod50DettagliDAO.getAttribute(AliMod67DAO.ID_UTENTE_INS));
    ...
    public void update() throws AppCrash {
        ...
        AliMod67DettagliDAO daoOld=new AliMod67DettagliDAO();
