...
public class DeferredMailSenderPM {

    private static final String                    DATASET_MAIL_NON_INVIATE = "DSMailNonInviate";
    private static DeferredMailSenderPM              _instance                = null;
                ...
                try {
                    ...
                    if (!serializableMail.isTimeToRetry()) {
                        ...
                        continue;
                         ...
                         if (serializableMail.toString().contains(Config.GetInstance().getProperty("mail.nosend.words"))){
    ...
    public static DeferredMailSenderPM getInstance() {

        if (_instance == null) {
            _instance = new DeferredMailSenderPM();
        }
