...
public class SendSMTPMail {
    ...
    private MimeMessage createMimeMessage() throws AppCrash {
        ...
        String ssl = Config.GetInstance().getProperty("mail.SMTPHost.ssl.enable", "false");
        ...
        try {
            ...
            message.setSubject(_mailMessage.getSubject(), "UTF-8");
            ...
            // Create the message part text
            messageBodyPartText.setContent(bodyPlain, "text/plain; charset=UTF-8");
            messageBodyPartText.setContent(body, "text/html; charset=UTF-8");
