...
public class CreateLIMOD71Fronte extends CreatePDF {

    public CreateLIMOD71Fronte(String templateFile, String outDirectory, Map<String, Object> map) {
    ...
    public static void main(String[] args) {
        ...
        CreatePDF pdf = new CreateLIMOD71Fronte("D:/works/LIMOD71.pdf", "D:/works/", data);
        pdf.setTest(true);
