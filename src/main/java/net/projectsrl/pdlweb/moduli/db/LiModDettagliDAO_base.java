...
public abstract class LiModDettagliDAO_base extends PjNDAO_base {
    ...
    public LiModDettagliDAO_base(DBTransaction transact, String tableName) throws AppCrash {

        super(transact, tableName);
    }

    public LiModDettagliDAO_base(String tableName, String configName) throws AppCrash {

        super(tableName, configName);

    }

    public LiModDettagliDAO_base(String tableName) throws AppCrash {
