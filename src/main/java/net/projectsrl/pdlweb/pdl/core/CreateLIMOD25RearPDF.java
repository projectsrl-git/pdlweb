...
public class CreateLIMOD25RearPDF extends CreateAcroFieldsPDF_base {
	
	private static final String PDF_TEMPLATE_NAME = "pdla4retro.pdf";
    private static final int    MAX_ROWS_IN_PAGE  = 3;

    public CreateLIMOD25RearPDF(String outDirectory, Map<String, Object> map) {
