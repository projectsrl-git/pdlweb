...
public class CreateLIMOD25RearPDFEnRev9 extends CreateAcroFieldsPDF_base {
	
	private static final String PDF_TEMPLATE_NAME = "pdla4retro_en_rev10.pdf";
    private static final int    MAX_ROWS_IN_PAGE  = 3;

    public CreateLIMOD25RearPDFEnRev9(String outDirectory, Map<String, Object> map) {
