...
public class CreateLIMOD25RearPDFEn extends CreateAcroFieldsPDF_base {
	
	private static final String PDF_TEMPLATE_NAME = "pdla4retro_en.pdf";
    private static final int    MAX_ROWS_IN_PAGE  = 3;

    public CreateLIMOD25RearPDFEn(String outDirectory, Map<String, Object> map) {
