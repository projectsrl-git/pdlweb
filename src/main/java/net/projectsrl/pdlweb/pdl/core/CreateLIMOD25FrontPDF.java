...
public class CreateLIMOD25FrontPDF extends CreateAcroFieldsPDF_base {
	
	private static final String PDF_TEMPLATE_NAME = "pdla4fronte.pdf";
    private static final int    MAX_ROWS_IN_PAGE  = 3;

    public CreateLIMOD25FrontPDF(String outDirectory, Map<String, Object> map) {
