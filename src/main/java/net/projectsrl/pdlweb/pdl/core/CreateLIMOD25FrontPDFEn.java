...
public class CreateLIMOD25FrontPDFEn extends CreateAcroFieldsPDF_base {
	
	private static final String PDF_TEMPLATE_NAME = "pdla4fronte_en.pdf";
    private static final int    MAX_ROWS_IN_PAGE  = 3;

    public CreateLIMOD25FrontPDFEn(String outDirectory, Map<String, Object> map) {
