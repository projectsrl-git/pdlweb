...
public class FunctionDownloadStoricoInterferenze extends FunctionProjectWebApp_base {

    public FunctionDownloadStoricoInterferenze(ApplicationServices_itf applServices, String functionID, String functionName) {
    ...
    public void mostra(SsbServletRequest request, SsbServletResponse response, UserSecurityInfo userInfo)
        ...
        try {
            File file = new File(Config.GetInstance().getProperty("cartella.storicointerferenze.pdf.output",_applicationSrv.getRoot())  + File.separator + fileName);
