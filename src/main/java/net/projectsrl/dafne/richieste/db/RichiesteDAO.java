...
public class RichiesteDAO extends PjNDAO_base {

    private static final String TABLE_NAME        = "RICHIESTE";

    private FeriePermessiDAO     _richiesteLog;
    ...
    public RichiesteDAO() throws AppCrash {

        super(TABLE_NAME);
        _richiesteLog = new FeriePermessiDAO();
    }

    public RichiesteDAO(DBTransaction transact) throws AppCrash {
    ...
    public void insert() throws AppCrash {
        ...
        _richiesteLog.setAttribute(ID_RICHIESTA, rowId);
        _richiesteLog.setAttribute(ID_UTENTE_INS, idUtenteIns);
        _richiesteLog.setAttribute(TS_INS, tsIns);
        _richiesteLog.setAttribute(STATO_RICHIESTA, StatiRichiesta.WAITNG_FOR_FIRST_APPROVAL.getCode());
        _richiesteLog.insert();
    }
    ...
    public void update() throws AppCrash {
        ...
        _richiesteLog.setAttribute(ID_RICHIESTA, idRichiesta);
        _richiesteLog.setAttribute(ID_UTENTE_INS, idUtenteMod);
        _richiesteLog.setAttribute(TS_INS, tsMod);
        _richiesteLog.updateLastAsOldAndInsertNew();
    ...
    public void setAttributesFromRequest(SsbServletRequest req) throws AppCrash {
        ...
        _richiesteLog.setAttributesFromRequest(req);
