...
import net.projectsrl.dafne.richieste.db.RichiesteMalattieInfortuniDAO;
 ...
 */
public class FunctionInserimentoMalattieInfortuni extends FunctionAjaxForm_base<RichiesteMalattieInfortuniDAO> {

    public FunctionInserimentoMalattieInfortuni(ApplicationServices_itf applServices, String functionID,
            String functionName) {
    ...
    @Override
    protected void insert(SsbServletRequest req, RichiesteMalattieInfortuniDAO formDao, UserSecurityInfo userInfo) throws AppCrash {

        formDao.setAttributesFromRequest(req);
        TipiRichiestaDAO tipoRichiesta = new TipiRichiestaDAO();
        tipoRichiesta.setAttribute(TipiRichiestaDAO.CODICE, TipiRichiesta.MAL.toString());
    ...
    @Override
    protected void update(SsbServletRequest req, RichiesteMalattieInfortuniDAO formDao, UserSecurityInfo userInfo) throws AppCrash {
    ...
    protected void sendResponseJSON(SsbServletResponse res, boolean result, String title, String message,
    		RichiesteMalattieInfortuniDAO formDao) {
