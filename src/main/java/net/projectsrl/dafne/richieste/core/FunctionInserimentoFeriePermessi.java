 ...
 */
public class FunctionInserimentoFeriePermessi extends FunctionAjaxForm_base<RichiesteDAO> {

    public FunctionInserimentoFeriePermessi(ApplicationServices_itf applServices, String functionID,
            String functionName) {
    ...
    protected void insert(SsbServletRequest req, RichiesteDAO formDao, UserSecurityInfo userInfo) throws AppCrash {
        ...
        tipoRichiesta.setAttribute(TipiRichiestaDAO.CODICE, TipiRichiesta.FER.toString());
