...
group by v1.id_azienda,v1.id_impianto,al.ID_AREA,ID_PDL
	...
	,dt_attivazione
	,NOME_COGNOME_PREPOSTO_IMPRESA
	,NOME_IMPRESA,fl_tutto_impianto,id_pdl_corretto,gestione_interferenza
order by al.id_area;
...
group by id_azienda ,ID_IMPIANTO,ID_AREA,ID_PDL	,NR_PDL	,DESCRIZIONE_LAVORO	,dt_attivazione	,NOME_COGNOME_PREPOSTO_IMPRESA,NOME_IMPRESA,V_SIMULAZIONE_PDL_TUTTO_IMPIANTO.EMAIL,fl_tutto_impianto,fl_tutto_impianto_simulato,id_pdl_corretto,gestione_interferenza
order by id_area
;
